...
| [threejs](skills/threejs/SKILL.md) | Build, review, debug, and optimize production Three.js experiences across scene architecture, render loops, assets, shaders, DOM coordination, GPU lifecycle, and performance. The skill discovers its detailed guidance dynamically from `rules/`. |
