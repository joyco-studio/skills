...
| [joyco-ui](skills/joyco-ui/SKILL.md) | Build interfaces with the JOYCO UI kit — a bento/console-style component library on shadcn/ui, Radix, and Tailwind. Covers the Cluster/Filler layout model, the component API reference, theme tokens, and `data-slot` styling conventions. |
